...
const Add = (props) => {
    ...
    const [idea, setIdea] = useState({ title: '', description: '', tags: [], media: 'Select a file' })
    ...
    if (addindex === 1) {
        return <div className='addpost-form'>
            ...
            <div className='addpost-form-end-buttons'>
                ...
                <label id="file-input-label" for="myFile" className='addpost-form-media-label'>{idea.media}</label>
