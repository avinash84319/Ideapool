...
/* 
create table posts(postid int auto_increment primary key,account_username varchar(20),account_img longtext,idea_time text,idea_title text,idea_abstract text,idea_intrests text,idea_image longtext,idea_likes int,idea_comments text,messages text);
...
create table uimage(username text,image longtext);
*/
